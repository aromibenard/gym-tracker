...
import { editSet } from '@/lib/actions/edit-set'
        ...
        <div>
            ...
            >
                <div className='flex flex-col space-y-2'>
                    ...
                    <input type='hidden' name='sessionExerciseId' value={setData.sessionExerciseId} />

                    <Label htmlFor='order'>Set Order</Label>
                    <Select name='order' defaultValue={setData.order.toString()} >
                ...
                <div className='flex flex-col space-y-2'>
                    ...
                    <Input 
                        ...
                        id='weight'
                        type='number'
                        defaultValue={setData.weight.toString()}
                    />
                ...
                <div className='flex flex-col space-y-2'>
                    ...
                    <Input 
                        ...
                        id='reps'
                        type='number'
                        defaultValue={setData.reps.toString()}
                    />
